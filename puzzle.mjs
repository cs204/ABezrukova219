...
знания2.добавить(new Эквивалентность(new Или(new И(АРыцарь, new Не(БЛжец)), new И(АЛжец, new Не(БРыцарь))), АРыцарь));
знания2.добавить(new Эквивалентность(new Или(new И(АРыцарь, БЛжец), new И(АЛжец, БРыцарь)), БРыцарь));
знания2.добавить(new Эквивалентность(new Или(АРыцарь, new Не(АРыцарь)), БРыцарь));
...
// Б сказал: "А сказал 'Я лжец'."
знания3.добавить(new Эквивалентность(new И(АРыцарь, БРыцарь), БРыцарь));

// Б сказал: "В - лжец."
знания3.добавить(new Эквивалентность(БЛжец, ВРыцарь));
знания3.добавить(new Эквивалентность(БРыцарь, ВЛжец));

// В сказал: "А - рыцарь."
знания3.добавить(new Эквивалентность(АРыцарь, ВРыцарь));
знания3.добавить(new Эквивалентность(АЛжец, ВЛжец));
